...
const CASES = {
  "winning-over-sweden": {
    ...
    sections: [
      ...
      { p: ["Swedish law hands you dozens of player-safety rules: deposit limits, reality checks, session reminders. Add them at the end and the whole experience buckles under them. So I went through every <b>Spelinspektionen</b> (the regulator) requirement and mapped each one to a UI pattern and the copy it needed. By the first wireframe, compliance was already part of the design."],
        figure: { src: "images/winning-over-sweden/requirements-map.webp", zoom: true, side: true, caption: "The UX Requirements Map, regulation → UX pattern → design action. Tap to read in full." } },
      ...
      { eyebrow: "Building blocks", h: "The component library",
      ...
      { eyebrow: "Finding 01 · Bonus claim", h: "Keep users in context",
  ...
  "user-research-framework": {
    ...
    sections: [
      { eyebrow: "Overview", h: "Starting from zero", p: [
      ...
      { eyebrow: "The starting point", h: "What that looked like", p: [
      ...
      { chapter: { no: "02", hud: "The schedule", title: "Research on a schedule",
      ...
      { eyebrow: "Measuring it", h: "Tracking satisfaction", p: [
...
function renderCase(slug) {
  ...
  const body = c.sections.map((s) => {
    ...
    if (s.carousel) {
      ...
      if (carCls) carHtml = carHtml.replace('class="cs-car"', `class="${carCls}"`);
      media += carHtml;
    }
